...
class Asignare(Entity):
    ...
    def __str__(self):
        return f"Id Asignare: {self.getIdEntity()}, Id Student: {self.__idStudent}, Numar laborator_Numar Problema: {self.__nrLab_nrProblema}, nota: {self.__nota}"